...
extern "C"
{
    ...
    int p101_dn_expand(const struct p101_env *env, struct p101_error *err, const unsigned char *msg, const unsigned char *eomorig, const unsigned char *comp_dn, char *exp_dn,
                       int length);
    ...
    int p101_res_nquerydomain(const struct p101_env *env, struct p101_error *err, res_state statep, const char *name, const char *domain, int cls, int type, unsigned char *answer,
                              int anslen);
    int p101_res_nmkquery(const struct p101_env *env, struct p101_error *err, res_state statep, int op, const char *dname, int cls, int type, const unsigned char *data,
