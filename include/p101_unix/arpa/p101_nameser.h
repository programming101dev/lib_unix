...
extern "C"
{
    ...
    u_int  p101_ns_get16(const struct p101_env *env, struct p101_error *err, const unsigned char *src);
    u_long p101_ns_get32(const struct p101_env *env, struct p101_error *err, const unsigned char *src);
